 ...
 * box (lon -110..5, lat -5..45 — the app's frame), rounds to 2 decimals, and
...
// s matches the frame's hard 5S edge (app.js PAN_BOUNDS) — drawing land past
// the pannable frame just leaks into the chart-fit letterbox band
const BOX = { w: -110, e: 5, s: -5, n: 45 };
 ...
 * Natural Earth 1:50m (public domain), clipped to lon -110..5 / lat -5..45,
