...
shell_changed=$(printf '%s\n' "$changed" | grep -E '^(index\.html|app\.js|parser\.js|diff\.js|basemap\.js|countries\.js|sample\.js|phonetics\.js|sw\.js|manifest\.json|favicon\.svg|icon-.*\.png|apple-touch-icon-180\.png)$')
